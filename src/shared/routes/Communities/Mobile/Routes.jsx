...
import BsicHackathon from 'containers/tc-communities/mobile/BsicIncubator';
import ChallengeListingTopBanner from
  'components/tc-communities/communities/mobile/ChallengeListing/TopBanner';
import ChallengeListingRegisterToSee from
  'components/tc-communities/communities/mobile/ChallengeListing/RegisterToSee';
...
import socialImage from 'assets/images/communities/mobile/social.jpg';

import Leaderboard from '../Leaderboard';

export default function Mobile({ base, member, meta }) {
  return (
    <Route
      component={({ match }) => (
        <ThemeProvider theme={{
